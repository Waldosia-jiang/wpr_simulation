...
if(NOT "/home/wheeltec/wpr_simulation/src/wpb_home/wpbh_local_planner/include " STREQUAL " ")
  set(wpbh_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/wheeltec/wpr_simulation/src/wpb_home/wpbh_local_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wpbh_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/wpr_simulation/src/wpb_home/wpbh_local_planner/${idir}'.  ${_report}")
    endif()
